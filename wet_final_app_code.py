    ...
    with col1:
        ...
        if st.button("📸 Capture Image from Camera", key="camera_btn"):
            ...
            with st.spinner("📸 Capturing image from camera module..."):
                ...
                st.session_state.camera_image_path = "sample.jpg"
            ...
            if model is None:
                ...
                with st.spinner("🧠 Analyzing soil moisture with AI..."):
                    if uploaded_file:
                        ...
                        image_path = "sample.jpg"  # Replace with your demo image
...
#Comparisions
    ...
    Below is a wet soil condition.
    """)

    # Hardcoded values (for wet soil condition)
    hardcoded_predicted = 78.2  # %
    hardcoded_sensor = 82.7     # %
    ...
    st.markdown(f"""
    ✅ **Soil is wet** according to both model and sensor:  
    ...
    # Sample 10 readings for wet soil
    time_steps = list(range(1, 11))
    sensor_values = [83.1, 83.0, 82.9, 82.7, 82.5, 82.4, 82.2, 82.0, 81.9, 81.7]
    model_values =  [77.5, 77.8, 78.0, 78.2, 78.1, 78.0, 77.8, 77.6, 77.4, 77.2]
